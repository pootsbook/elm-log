...
ActiveRecord::Schema.define(version: 20161123073321) do
  ...
  create_table "link_summaries", force: :cascade do |t|
    t.jsonb    "raw"
    t.string   "type"
    t.integer  "extracted_url_id"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
  end

  add_index "link_summaries", ["extracted_url_id"], name: "index_link_summaries_on_extracted_url_id", using: :btree
